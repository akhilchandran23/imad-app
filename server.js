...
var config = {
    user: 'chandranakhil23',
    database: 'chandranakhil23',
...
var articles = { 
    ...
    'article-two': {
        title: 'Article Two | Akhil Chandran',
        heading: 'Article Two',
        date: 'August 10, 2017',
        content: ` 
                <p>
    ...
    'article-three': {
        title: 'Article Three | Akhil Chandran',
...
app.get('/test-db', function (req, res) {
    ...
    pool.query('SELEC * FROM test', function (err, result)  {
       if (err) {
